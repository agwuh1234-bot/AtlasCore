...
function collapseSidebar(){if(innerWidth>=980)return;document.body.classList.remove('atlas-sidebar-open');try{localStorage.setItem('atlas_sidebar_open','0')}catch(_){}$('#atlasSidebarToggle')?.setAttribute('aria-expanded','false')}
