...
document.addEventListener('keydown',e=>{if(e.key==='Escape'&&innerWidth<980&&document.body.classList.contains('atlas-sidebar-open')){collapseSidebar();$('#atlasSidebarToggle')?.focus()}});
