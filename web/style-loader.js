...
let started=false;
function enable(){if(started)return;started=true;const links=[...document.querySelectorAll(SELECTOR)];for(const link of links){link.media='all';link.removeAttribute('data-atlas-deferred-style')}}
