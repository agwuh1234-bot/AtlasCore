...
- Изменение кода или данных сначала помещай в очередь разрешений и выполняй только после отдельного подтверждения во вкладке «Контроль».
...
PERMISSION_LEVELS = [
    ...
    },
    {
        ...
        "description": "Atlas может подготовить конкретное изменение, но выполнит его только после подтверждения во вкладке «Контроль».",
        "automatic": False,
        "confirmation": True,
    },
    {
